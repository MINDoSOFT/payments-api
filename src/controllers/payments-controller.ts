...
import { ERROR_ALREADY_APPROVED_CODE, ERROR_ALREADY_APPROVED_MESSAGE, ERROR_ALREADY_CANCELLED_CODE, ERROR_ALREADY_CANCELLED_MESSAGE, ERROR_CANNOT_APPROVE_CODE, ERROR_CANNOT_APPROVE_MESSAGE, ERROR_CANNOT_CANCEL_CODE, ERROR_CANNOT_CANCEL_MESSAGE, ERROR_VALIDATION_CODE, ERROR_VALIDATION_MESSAGE } from "../enums/api-error-codes";
...
export class PaymentsController {
    ...
    getPayments = async (_req: ListPaymentsRequest, res: ListPaymentsResponse) => {
    ...
    createPayment = async (req: CreatePaymentRequest, res: CreatePaymentResponse & ErrorResponse) => {
        ...
        try {
          const resPayment = await this.paymentRepository.findOne({ _id: reqPaymentId });
    ...
    getPayment = async (req: GetPaymentRequest, res: GetPaymentResponse & ErrorResponse) => {
        ...
        try {
          const resPayment = await this.paymentRepository.findOne({ _id: paymentId });
    ...
    approvePayment = async (req: ApprovePaymentRequest, res: ApprovePaymentResponse & ErrorResponse) => {
    ...
    cancelPayment = async (req: CancelPaymentRequest, res: CancelPaymentResponse & ErrorResponse) => {
