export const JWT_SINGING_KEY = 'A VERY SECRET SIGNING KEY'; // TODO Put this in the vault (future todo use certificate)

export const HELLO_WORLD_ENDPOINT = '/';
export const AUTHENTICATE_ENDPOINT = '/v1/authenticate';
